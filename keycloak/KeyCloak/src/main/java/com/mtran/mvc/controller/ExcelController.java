...
import com.mtran.mvc.service.impl.ExcelUserServiceImpl;
...
public class ExcelController {
    private final ExcelUserServiceImpl userService;
    ...
    public ResponseEntity<byte[]> exportUsers(
        ...
        byte[] excelBytes = userService.exportUsersToExcel(username, fullName, createdDateFrom, createdDateTo, experienceYears);

         userService.exportUsersToExcelAndStore(username, fullName, createdDateFrom, createdDateTo, experienceYears, owner);
    ...
    public ResponseEntity<?> importUsersFromExcel(@RequestParam("file") MultipartFile file) {
        int result = userService.importUsersFromExcel(file);
