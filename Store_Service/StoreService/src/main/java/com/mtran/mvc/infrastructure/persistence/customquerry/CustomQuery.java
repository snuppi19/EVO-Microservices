package com.mtran.mvc.infrastructure.persistence.customquerry;
...
public class CustomQuery {
    public static Specification<FileEntity>filterFiles(String name, String owner, Boolean visibility,
